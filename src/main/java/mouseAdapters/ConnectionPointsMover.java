 ...
 */
public class ConnectionPointsMover extends MouseAdapter
{
	...
	public void mouseReleased(MouseEvent e)
	{
                ...
                {
                    String connectionPointName = connectionPoint.getName();
                    if (connectionPointName == null || !movedConnectionPoint.getName().equals(connectionPointName))
                    {
                        ...
                        if (connectionPoint.getAnchor() == java.awt.GridBagConstraints.NORTHEAST) // compare lower right corner
                        {
                            ...
                            destiny.x += movedConnectionPoint.getWidth();
